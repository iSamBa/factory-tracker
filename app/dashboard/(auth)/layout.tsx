...
import { StatusDisplayProvider } from "@/components/status-display-provider";
import { getStatusDisplayMap } from "@/lib/settings";
...
export default async function AuthLayout({
  ...
  return (
    <StatusDisplayProvider value={statusDisplay}>
    <SidebarProvider
